...
function Strategy(options, verify) {
  ...
  this._userProfileURL =
    options.userProfileURL || 'https://slack.com/api/users.profile.get';
...
function wrapVerify(slackAuthOptions) {
  return function _verify(
    ...
    if (!slackAuthOptions.passReqToCallback) {
      slackAuthOptions.verify(accessToken, params, profile, verified);
    } else {
      slackAuthOptions.verify(req, accessToken, params, profile, verified);
    }
  };
}
