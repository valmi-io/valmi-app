    ...
    MuiOutlinedInput: {
      styleOverrides: {
        root: {
          ...
          '&.Mui-disabled': {
            backgroundColor: colors.alpha.black[1],
            cursor: 'not-allowed'
          },
          '&:hover .MuiOutlinedInput-notchedOutline': {
            //borderColor: colors.alpha.black[5]
          },
        ...
        list: {
          ...
          '& .MuiMenuItem-root.MuiButtonBase-root': {
            ...
            '&:hover, &:active, &.active, &.Mui-selected': {
              color: colors.alpha.black[100],
              background: alpha(colors.primary.main, 0.4)
            }
          }
        }
      }
    ...
    MuiStepper: {
      styleOverrides: {
        root: {
          paddingTop: 20,
          paddingBottom: 20,
          background: colors.alpha.black[1]
        }
      }
    },
    MuiStepIcon: {
