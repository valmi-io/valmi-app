...
const SyncsPage: NextPageWithLayout = () => {
  ...
  return (
    <PageLayout pageHeadTitle="DESTINATION" title="destination" buttonTitle="DESTINATION" handleButtonOnClick={handleCreateSyncOnClick}>

    <h1>This is Destinations Page</h1>
    </PageLayout>
  );
};
